...
# 3.Research method
The data was downloaded from the Inside Airbnb website (http://insideairbnb.com/get-the-data). Accordingly, the calendar and reviews csv files were downloaded into R for Amsterdam, Paris and New York. ANOVA was chosen as an appropriate analysis method as we are looking for a causal(dependence) relationship between listings prices during Easter, Christmas and New Year's, and whether these price fluctiations vary depending on the type of room, superhosy status and the number of people that can be accomodated. For prototyping purposes, only 100000 were taken for the analyses, as generally very broad samples tend to give significance, despite the impact not being big.
...
### Paris
![Paris ANOVA](https://raw.githubusercontent.com/edinescu/fork-price-change-public-holidays/master/images/PARIS%20ANOVA%20OUTPUT.png)
...
### Amsterdam
![Amsterdam](https://raw.githubusercontent.com/edinescu/fork-price-change-public-holidays/master/images/AMSTERDAM%20ANOVA%20OUTPUT.png)
...
### New York
![New York](https://raw.githubusercontent.com/edinescu/fork-price-change-public-holidays/master/images/NEW%20YORK%20ANOVA%20OUTPUT.png)
...
![plot](https://raw.githubusercontent.com/edinescu/fork-price-change-public-holidays/master/images/nr%20of%20rooms.png)
...
![plots](https://raw.githubusercontent.com/edinescu/fork-price-change-public-holidays/master/images/superhost.png) 
