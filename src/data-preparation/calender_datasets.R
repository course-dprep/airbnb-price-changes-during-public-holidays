...
#setwd("/Users/mynitran/Documents/Tilburg university/Msc Marketing Analytics/Skills Data Prep.& Workflow/Airbnb Project/team-assignment-airbnb-price-changes-during-public-holidays/src/data-preparation")
...
for (city in cities) {
  ...
  write_csv(df, paste0('../../gen/data-preparation/temp/', city, "_calendar.csv"))
}
